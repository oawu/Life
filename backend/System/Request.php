...
final class Request {
  ...
  private static function _recursiveUrlDecode(array $array): array {
    foreach ($array as $key => $value) {
      if (is_array($value)) {
        $array[$key] = self::_recursiveUrlDecode($value);
      } else {
  ...
  public static function getQueries(): array {
    ...
    $queries = ['val' => self::_recursiveUrlDecode(isset($_GET) && is_array($_GET) ? $_GET : [])];
